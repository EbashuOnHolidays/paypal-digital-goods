...
class PayPal_Subscription extends PayPal_Digital_Goods
{
    ...
    public function manage_subscription_status($profile_id, $status, $note = '')
    {
        ...
        return $this->call_paypal('ManageRecurringPaymentsProfileStatus', $profile_id, $status, ['note' => $note]);
    }
     ...
     */
    protected function get_payment_details_url($action, $profile_id = '', $status = '', $args = [])
    {
